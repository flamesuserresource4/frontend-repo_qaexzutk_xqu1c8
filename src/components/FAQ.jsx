  ...
  return (
    <section id="faq" className="py-16 bg-gradient-to-b from-white to-sky-50/40">
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-2xl sm:text-3xl font-semibold text-slate-800">Veelgestelde vragen</h2>
        <div className="mt-6 space-y-4">
          {items.map((it,i)=> (
            <details key={i} className="bg-white/80 border border-slate-200 rounded-xl px-4 py-3">
